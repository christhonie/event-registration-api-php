...
namespace Idealogic\RegistrationAPI;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://admin-service-dev.idealogic.co.za';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.0.6-SNAPSHOT/PHP';
    ...
    {
        $report  = 'PHP SDK (Idealogic\RegistrationAPI) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.2.0-SNAPSHOT' . PHP_EOL;
        $report .= '    SDK Package Version: 2.0.6-SNAPSHOT' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://admin-service-dev.idealogic.co.za",
