...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost:12504';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.2.2/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.3.22-SNAPSHOT' . PHP_EOL;
