...
class PersonResourceApi
{
     ...
     * @deprecated
     */
    public function findByIdDetails($person_match_dto, string $contentType = self::contentTypes['findByIdDetails'][0])
    {
        list($response) = $this->findByIdDetailsWithHttpInfo($person_match_dto, $contentType);
        return $response;
    }
     ...
     * @deprecated
     */
    public function findByIdDetailsWithHttpInfo($person_match_dto, string $contentType = self::contentTypes['findByIdDetails'][0])
    {
        $request = $this->findByIdDetailsRequest($person_match_dto, $contentType);
     ...
     * @deprecated
     */
    public function findByIdDetailsAsync($person_match_dto, string $contentType = self::contentTypes['findByIdDetails'][0])
    {
        return $this->findByIdDetailsAsyncWithHttpInfo($person_match_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function findByIdDetailsAsyncWithHttpInfo($person_match_dto, string $contentType = self::contentTypes['findByIdDetails'][0])
    {
        $returnType = '\Idealogic\RegistrationAPI\Model\PersonDTO[]';
        $request = $this->findByIdDetailsRequest($person_match_dto, $contentType);
     ...
     * @deprecated
     */
    public function findByIdDetailsRequest($person_match_dto, string $contentType = self::contentTypes['findByIdDetails'][0])
    {
     ...
     *
     * @param  mixed $user_key user_key (required)
     * @param  int $organisation_id organisation_id (optional)
     ...
     *
     * @param  Pageable $arg0 arg0 (required)
     * @param  int $organisation_id organisation_id (optional)
     * @param  string $user_key user_key (optional)
     ...
     * @return mixed
     */
    public function getAllLinkedOrgUsersByPrincipal($arg0, $organisation_id = null, $user_key = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        list($response) = $this->getAllLinkedOrgUsersByPrincipalWithHttpInfo($arg0, $organisation_id, $user_key, $contentType);
        return $response;
    }
     ...
     */
    public function getAllLinkedOrgUsersByPrincipalWithHttpInfo($arg0, $organisation_id = null, $user_key = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        $request = $this->getAllLinkedOrgUsersByPrincipalRequest($arg0, $organisation_id, $user_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllLinkedOrgUsersByPrincipalAsync($arg0, $organisation_id = null, $user_key = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        return $this->getAllLinkedOrgUsersByPrincipalAsyncWithHttpInfo($arg0, $organisation_id, $user_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllLinkedOrgUsersByPrincipalAsyncWithHttpInfo($arg0, $organisation_id = null, $user_key = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        $returnType = 'mixed';
        $request = $this->getAllLinkedOrgUsersByPrincipalRequest($arg0, $organisation_id, $user_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllLinkedOrgUsersByPrincipalRequest($arg0, $organisation_id = null, $user_key = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {

        // verify the required parameter 'arg0' is set
        if ($arg0 === null || (is_array($arg0) && count($arg0) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arg0 when calling getAllLinkedOrgUsersByPrincipal'
            );
        }
     ...
     * @return \Idealogic\RegistrationAPI\Model\PersonDTO[]
     */
    public function getAllPeople($page = 0, $size = 20, $sort = null, string $contentType = self::contentTypes['getAllPeople'][0])
    {
        list($response) = $this->getAllPeopleWithHttpInfo($page, $size, $sort, $contentType);
        return $response;
    }
     ...
     * @return array of \Idealogic\RegistrationAPI\Model\PersonDTO[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllPeopleWithHttpInfo($page = 0, $size = 20, $sort = null, string $contentType = self::contentTypes['getAllPeople'][0])
    {
        $request = $this->getAllPeopleRequest($page, $size, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllPeopleAsync($page = 0, $size = 20, $sort = null, string $contentType = self::contentTypes['getAllPeople'][0])
    {
        return $this->getAllPeopleAsyncWithHttpInfo($page, $size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllPeopleAsyncWithHttpInfo($page = 0, $size = 20, $sort = null, string $contentType = self::contentTypes['getAllPeople'][0])
    {
        $returnType = '\Idealogic\RegistrationAPI\Model\PersonDTO[]';
        $request = $this->getAllPeopleRequest($page, $size, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllPeopleRequest($page = 0, $size = 20, $sort = null, string $contentType = self::contentTypes['getAllPeople'][0])
    {
    ...
    /**
     * Operation getMemberView
     *
     * @param  int $id id (required)
     * @param  int $organisation_id organisation_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMemberView'] to see the possible values for this operation
     *
     * @throws \Idealogic\RegistrationAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Idealogic\RegistrationAPI\Model\MemberViewDTO
     */
    public function getMemberView($id, $organisation_id = null, string $contentType = self::contentTypes['getMemberView'][0])
    {
        list($response) = $this->getMemberViewWithHttpInfo($id, $organisation_id, $contentType);
        return $response;
    }

    /**
     * Operation getMemberViewWithHttpInfo
     *
     * @param  int $id (required)
     * @param  int $organisation_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMemberView'] to see the possible values for this operation
     ...
     * @throws \Idealogic\RegistrationAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Idealogic\RegistrationAPI\Model\MemberViewDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMemberViewWithHttpInfo($id, $organisation_id = null, string $contentType = self::contentTypes['getMemberView'][0])
    {
        $request = $this->getMemberViewRequest($id, $organisation_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Idealogic\RegistrationAPI\Model\MemberViewDTO' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Idealogic\RegistrationAPI\Model\MemberViewDTO' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Idealogic\RegistrationAPI\Model\MemberViewDTO', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Idealogic\RegistrationAPI\Model\MemberViewDTO';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Idealogic\RegistrationAPI\Model\MemberViewDTO',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMemberViewAsync($id, $organisation_id = null, string $contentType = self::contentTypes['getMemberView'][0])
    {
        return $this->getMemberViewAsyncWithHttpInfo($id, $organisation_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMemberViewAsyncWithHttpInfo
     *
     * @param  int $id (required)
     * @param  int $organisation_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMemberView'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMemberViewAsyncWithHttpInfo($id, $organisation_id = null, string $contentType = self::contentTypes['getMemberView'][0])
    {
        $returnType = '\Idealogic\RegistrationAPI\Model\MemberViewDTO';
        $request = $this->getMemberViewRequest($id, $organisation_id, $contentType);
    ...
    /**
     * Create request for operation 'getMemberView'
     *
     * @param  int $id (required)
     * @param  int $organisation_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMemberView'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMemberViewRequest($id, $organisation_id = null, string $contentType = self::contentTypes['getMemberView'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getMemberView'
            );
        }



        $resourcePath = '/api/people/{id}/member-view';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  Pageable $arg1 arg1 (required)
     ...
     * @throws \Idealogic\RegistrationAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed|\Idealogic\RegistrationAPI\Model\PersonDTO[]
     * @deprecated
     */
    public function queryPerson($q, $arg1, string $contentType = self::contentTypes['queryPerson'][0])
    {
        list($response) = $this->queryPersonWithHttpInfo($q, $arg1, $contentType);
        return $response;
    }
     ...
     * @param  Pageable $arg1 (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['queryPerson'] to see the possible values for this operation
     *
     * @throws \Idealogic\RegistrationAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of mixed|\Idealogic\RegistrationAPI\Model\PersonDTO[], HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function queryPersonWithHttpInfo($q, $arg1, string $contentType = self::contentTypes['queryPerson'][0])
    {
        $request = $this->queryPersonRequest($q, $arg1, $contentType);
     ...
     * @deprecated
     */
    public function queryPersonAsync($q, $arg1, string $contentType = self::contentTypes['queryPerson'][0])
    {
        return $this->queryPersonAsyncWithHttpInfo($q, $arg1, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryPersonAsyncWithHttpInfo($q, $arg1, string $contentType = self::contentTypes['queryPerson'][0])
    {
        $returnType = 'mixed';
        $request = $this->queryPersonRequest($q, $arg1, $contentType);
     ...
     * @deprecated
     */
    public function queryPersonRequest($q, $arg1, string $contentType = self::contentTypes['queryPerson'][0])
    {
        ...
        if ($arg1 === null || (is_array($arg1) && count($arg1) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arg1 when calling queryPerson'
            );
        }
