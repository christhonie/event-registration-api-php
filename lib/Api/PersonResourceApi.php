...
class PersonResourceApi
{
     ...
     * @return mixed
     */
    public function getAllLinkedOrgUsersByPrincipal($arg0, $user_key, $organisation_id = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        list($response) = $this->getAllLinkedOrgUsersByPrincipalWithHttpInfo($arg0, $user_key, $organisation_id, $contentType);
        return $response;
    }
     ...
     */
    public function getAllLinkedOrgUsersByPrincipalWithHttpInfo($arg0, $user_key, $organisation_id = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        $request = $this->getAllLinkedOrgUsersByPrincipalRequest($arg0, $user_key, $organisation_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllLinkedOrgUsersByPrincipalAsync($arg0, $user_key, $organisation_id = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        return $this->getAllLinkedOrgUsersByPrincipalAsyncWithHttpInfo($arg0, $user_key, $organisation_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllLinkedOrgUsersByPrincipalAsyncWithHttpInfo($arg0, $user_key, $organisation_id = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
        $returnType = 'mixed';
        $request = $this->getAllLinkedOrgUsersByPrincipalRequest($arg0, $user_key, $organisation_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllLinkedOrgUsersByPrincipalRequest($arg0, $user_key, $organisation_id = null, string $contentType = self::contentTypes['getAllLinkedOrgUsersByPrincipal'][0])
    {
