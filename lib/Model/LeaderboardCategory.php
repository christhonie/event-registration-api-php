...
/**
 * LeaderboardCategory Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class LeaderboardCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LeaderboardCategory';
    ...
    */
     ...
     *
     * @param mixed|null $points_multiplier points_multiplier
     *
     * @return self
     */
    public function setPointsMultiplier($points_multiplier)
    {
        if (is_null($points_multiplier)) {
            array_push($this->openAPINullablesSetToNull, 'points_multiplier');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('points_multiplier', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
