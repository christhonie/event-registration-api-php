 ...
 */
class Pageable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        if (!is_null($page) && ($page < 0)) {
            throw new \InvalidArgumentException('invalid value for $page when calling Pageable., must be bigger than or equal to 0.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (!is_null($size) && ($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Pageable., must be bigger than or equal to 1.');
        }
