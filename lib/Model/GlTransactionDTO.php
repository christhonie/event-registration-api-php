...
/**
 * GlTransactionDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class GlTransactionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GlTransactionDTO';
    ...
    */
     ...
     *
     * @param mixed $transaction_date transaction_date
     *
     * @return self
     */
     ...
     *
     * @param mixed $created_date_time created_date_time
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GlTransactionDTO., must be smaller than or equal to 50.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GlTransactionDTO., must be bigger than or equal to 0.');
        }
