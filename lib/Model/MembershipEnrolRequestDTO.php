 ...
 */
class MembershipEnrolRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MembershipEnrolRequestDTO';
    ...
    */
     ...
     *
     * @param mixed|null $membership_period membership_period
     *
     * @return self
     */
    public function setMembershipPeriod($membership_period)
    {
        if (is_null($membership_period)) {
            array_push($this->openAPINullablesSetToNull, 'membership_period');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('membership_period', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets persons
     *
     * @param mixed|null $persons persons
     *
     * @return self
     */
