...
class MembershipOrderLineItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets membership_id
     *
     * @param mixed $membership_id ID of the Membership record in the backend
     *
     * @return self
     */
     ...
     * Sets product
     *
     * @param \Idealogic\RegistrationAPI\Model\ProductDTO $product Product used in the line item
     *
     * @return self
     */
