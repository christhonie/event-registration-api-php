...
/**
 * OrganisationSetDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class OrganisationSetDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganisationSetDTO';
    ...
    */
     ...
     * Sets override
     *
     * @param mixed|null $override override
     *
     * @return self
     */
     ...
     * Sets effective
     *
     * @param mixed|null $effective effective
     *
     * @return self
     */
    public function setEffective($effective)
    {
        if (is_null($effective)) {
            array_push($this->openAPINullablesSetToNull, 'effective');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('effective', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
