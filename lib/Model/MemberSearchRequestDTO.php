...
/**
 * MemberSearchRequestDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class MemberSearchRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberSearchRequestDTO';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (!is_null($value) && (mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling MemberSearchRequestDTO., must be bigger than or equal to 1.');
        }
