...
class RaceResultDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets position
     *
     * @param mixed|null $position Position in the race. First place will be 1, followed by second as 2, etc.
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $duration_milli_second For duration based outcomes this indicates the duration underpinning the result.
     *
     * @return self
     */
    public function setDurationMilliSecond($duration_milli_second)
    {
        if (is_null($duration_milli_second)) {
            array_push($this->openAPINullablesSetToNull, 'duration_milli_second');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('duration_milli_second', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets laps
     *
     * @param mixed|null $laps Number of laps completed. Optional.
     *
     * @return self
     */
     ...
     * Sets points
     *
     * @param mixed|null $points For points based outcomes this indicates the points underpinning the result.
     *
     * @return self
     */
