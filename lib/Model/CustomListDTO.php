...
class CustomListDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param mixed $name A unique name for the list.
     *
     * @return self
     */
     ...
     * Sets display_name
     *
     * @param mixed|null $display_name The display name used on-screen or in reports
     *
     * @return self
     */
     ...
     * Sets meta_key
     *
     * @param mixed|null $meta_key Meta key to associate values from this list to a Person.
     *
     * @return self
     */
