...
/**
 * RecordPersonDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class RecordPersonDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecordPersonDTO';
    ...
    protected static $openAPITypes = [
        ...
        'record' => '\Idealogic\RegistrationAPI\Model\RecordDTO'
    ];
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RecordPersonDTO., must be smaller than or equal to 50.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RecordPersonDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RecordPersonDTO., must be smaller than or equal to 50.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RecordPersonDTO., must be bigger than or equal to 0.');
        }
     ...
     * Gets record
     *
     * @return \Idealogic\RegistrationAPI\Model\RecordDTO
     */
     ...
     * Sets record
     *
     * @param \Idealogic\RegistrationAPI\Model\RecordDTO $record record
     *
     * @return self
     */
