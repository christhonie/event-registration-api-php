 ...
 */
class BarcodeDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BarcodeDTO';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if (!is_null($code) && (mb_strlen($code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $code when calling BarcodeDTO., must be smaller than or equal to 20.');
        }
        if (!is_null($code) && (mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling BarcodeDTO., must be bigger than or equal to 0.');
        }
