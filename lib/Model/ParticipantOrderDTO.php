    ...
    */
    ...
    public function setReferenceCode($reference_code)
    {
        ...
        if (!is_null($reference_code) && (mb_strlen($reference_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $reference_code when calling ParticipantOrderDTO., must be smaller than or equal to 50.');
        }
        if (!is_null($reference_code) && (mb_strlen($reference_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference_code when calling ParticipantOrderDTO., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param mixed|null $event_participants event_participants
     *
     * @return self
     */
    public function setEventParticipants($event_participants)
    {
        if (is_null($event_participants)) {
            array_push($this->openAPINullablesSetToNull, 'event_participants');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('event_participants', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
