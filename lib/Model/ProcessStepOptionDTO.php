...
/**
 * ProcessStepOptionDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class ProcessStepOptionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProcessStepOptionDTO';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (!is_null($value) && (mb_strlen($value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ProcessStepOptionDTO., must be smaller than or equal to 100.');
        }
        if (!is_null($value) && (mb_strlen($value) < 0)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ProcessStepOptionDTO., must be bigger than or equal to 0.');
        }
     ...
     * Gets step
     *
     * @return \Idealogic\RegistrationAPI\Model\ProcessStepDTO
     */
     ...
     * Sets step
     *
     * @param \Idealogic\RegistrationAPI\Model\ProcessStepDTO $step step
     *
     * @return self
     */
