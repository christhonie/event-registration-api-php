...
class EventCategoryDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'target_categories' => '\Idealogic\RegistrationAPI\Model\EventCategoryDTO[]'
    ];
    ...
    */
     ...
     *
     * @param \Idealogic\RegistrationAPI\Model\EventCategoryDTO[]|null $feeder_categories Event Categories that feed into this event. Only applicable for race categories (raceCategory = true) and where sourceCategories are not set (thus ad-hoc EventCategories).
     *
     * @return self
     */
     ...
     *
     * @param \Idealogic\RegistrationAPI\Model\EventCategoryDTO[]|null $target_categories target_categories
     *
     * @return self
     */
    public function setTargetCategories($target_categories)
    {
        if (is_null($target_categories)) {
            throw new \InvalidArgumentException('non-nullable target_categories cannot be null');
        }
