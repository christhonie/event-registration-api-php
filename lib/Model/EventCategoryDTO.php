...
class EventCategoryDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets min_age
     *
     * @param mixed|null $min_age Override minimum allowed age for this category. Leave blank if not applicable.
     *
     * @return self
     */
     ...
     * Sets max_age
     *
     * @param mixed|null $max_age Override maximum allowed age for this category. Leave blank if not applicable.
     *
     * @return self
     */
     ...
     * Sets gender
     *
     * @param mixed|null $gender Override gender restriction for this category. Leave blank if not applicable.
     *
     * @return self
     */
     ...
     * Sets entry_category
     *
     * @param mixed|null $entry_category Indicate if this category can be used for new entries.
     *
     * @return self
     */
     ...
     * Sets race_category
     *
     * @param mixed|null $race_category Indicate if this category can be used in races.
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $source_category The underlying standard category this category is based on.
     *
     * @return self
     */
     ...
     * Sets product
     *
     * @param \Idealogic\RegistrationAPI\Model\ProductDTO|null $product The product to use when creating an entry based on this category.
     *
     * @return self
     */
