 ...
 */
class CustomList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomList., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomList., must be bigger than or equal to 0.');
        }
    ...
    public function setDisplayName($display_name)
    {
        ...
        if (!is_null($display_name) && (mb_strlen($display_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CustomList., must be smaller than or equal to 50.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CustomList., must be bigger than or equal to 0.');
        }
     ...
     * Sets display_code
     *
     * @param mixed $display_code display_code
     *
     * @return self
     */
     ...
     * Sets meta_key
     *
     * @param mixed|null $meta_key meta_key
     *
     * @return self
     */
    ...
    {
        if (is_null($meta_key)) {
            array_push($this->openAPINullablesSetToNull, 'meta_key');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('meta_key', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($meta_key) && (mb_strlen($meta_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $meta_key when calling CustomList., must be smaller than or equal to 50.');
        }
        if (!is_null($meta_key) && (mb_strlen($meta_key) < 0)) {
            throw new \InvalidArgumentException('invalid length for $meta_key when calling CustomList., must be bigger than or equal to 0.');
        }
