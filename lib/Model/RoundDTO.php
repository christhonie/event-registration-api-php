...
class RoundDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parent' => '\Idealogic\RegistrationAPI\Model\RoundDTO',
        'prev_round' => '\Idealogic\RegistrationAPI\Model\RoundDTO'
    ];
    ...
    */
     ...
     * Sets parent
     *
     * @param \Idealogic\RegistrationAPI\Model\RoundDTO|null $parent Used to create child rounds.
     *
     * @return self
     */
     ...
     * Sets prev_round
     *
     * @param \Idealogic\RegistrationAPI\Model\RoundDTO|null $prev_round The previous round in this Race.
     *
     * @return self
     */
    public function setPrevRound($prev_round)
    {
        if (is_null($prev_round)) {
            throw new \InvalidArgumentException('non-nullable prev_round cannot be null');
        }
