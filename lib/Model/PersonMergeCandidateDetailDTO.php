...
/**
 * PersonMergeCandidateDetailDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class PersonMergeCandidateDetailDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonMergeCandidateDetailDTO';
    ...
    */
     ...
     * Gets source_person
     *
     * @return \Idealogic\RegistrationAPI\Model\PersonMergeCandidatePersonDTO|null
     */
    public function getSourcePerson()
    {
        return $this->container['source_person'];
    }

    /**
     * Sets source_person
     *
     * @param \Idealogic\RegistrationAPI\Model\PersonMergeCandidatePersonDTO|null $source_person source_person
     *
     * @return self
     */
    public function setSourcePerson($source_person)
    {
        if (is_null($source_person)) {
            throw new \InvalidArgumentException('non-nullable source_person cannot be null');
        }
        $this->container['source_person'] = $source_person;
    ...
    {
        return $this->container['target_person'];
    }

    /**
     * Sets target_person
     *
     * @param \Idealogic\RegistrationAPI\Model\PersonMergeCandidatePersonDTO|null $target_person target_person
     *
     * @return self
     */
    public function setTargetPerson($target_person)
    {
        if (is_null($target_person)) {
            throw new \InvalidArgumentException('non-nullable target_person cannot be null');
        }
        $this->container['target_person'] = $target_person;
     ...
     * Sets reject_reason
     *
     * @param mixed|null $reject_reason reject_reason
     *
     * @return self
     */
