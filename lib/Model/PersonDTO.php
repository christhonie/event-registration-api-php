...
class PersonDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'gender_invalid' => 'bool',
        'process_instances' => '\Idealogic\RegistrationAPI\Model\ProcessInstanceDTO[]',
    ...
    */
     ...
     * Sets org_user_id
     *
     * @param int|null $org_user_id org_user_id
     *
     * @return self
     */
    public function setOrgUserId($org_user_id)
    {
        if (is_null($org_user_id)) {
            throw new \InvalidArgumentException('non-nullable org_user_id cannot be null');
        }
     ...
     *
     * @param \Idealogic\RegistrationAPI\Model\ProcessInstanceDTO[]|null $process_instances process_instances
     *
     * @return self
     */
    public function setProcessInstances($process_instances)
    {
        if (is_null($process_instances)) {
            throw new \InvalidArgumentException('non-nullable process_instances cannot be null');
        }
