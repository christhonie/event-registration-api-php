 ...
 */
class Counts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Counts';
    ...
    */
     ...
     * Sets unchanged
     *
     * @param mixed|null $unchanged unchanged
     *
     * @return self
     */
    public function setUnchanged($unchanged)
    {
        if (is_null($unchanged)) {
            array_push($this->openAPINullablesSetToNull, 'unchanged');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('unchanged', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
