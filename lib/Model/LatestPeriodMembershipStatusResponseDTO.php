...
class LatestPeriodMembershipStatusResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'membership_period_id' => 'mixed',
        'membership_period_name' => 'mixed',
        'main_member_id' => 'mixed',
        'status' => 'mixed'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'membership_period_id' => true,
        'membership_period_name' => true,
        'main_member_id' => true,
        'status' => true
    ];
    ...
    */
     ...
     *
     * @param mixed|null $membership_period_id membership_period_id
     *
     * @return self
     */
    public function setMembershipPeriodId($membership_period_id)
    {
        if (is_null($membership_period_id)) {
            array_push($this->openAPINullablesSetToNull, 'membership_period_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('membership_period_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $membership_period_name membership_period_name
     *
     * @return self
     */
    public function setMembershipPeriodName($membership_period_name)
    {
        if (is_null($membership_period_name)) {
            array_push($this->openAPINullablesSetToNull, 'membership_period_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('membership_period_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets main_member_id
     *
     * @param mixed|null $main_member_id main_member_id
     *
     * @return self
     */
    public function setMainMemberId($main_member_id)
    {
        if (is_null($main_member_id)) {
            array_push($this->openAPINullablesSetToNull, 'main_member_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('main_member_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
