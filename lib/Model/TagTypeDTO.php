...
class TagTypeDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets format
     *
     * @param mixed|null $format Format string, using Java String.format() specification, to display the tag number based on the sequence number. A mandatory %d field has to be provided.
     *
     * @return self
     */
     ...
     * Sets valid_from
     *
     * @param mixed $valid_from The default and earliest date tags of this type can be valid.
     *
     * @return self
     */
     ...
     * Sets valid_to
     *
     * @param mixed|null $valid_to The default and latest date tags of this type can be valid. Leave blank to leave unconstrained.
     *
     * @return self
     */
