...
/**
 * PersonMergeCandidateRejectDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class PersonMergeCandidateRejectDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonMergeCandidateRejectDTO';
    ...
    */
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && (mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling PersonMergeCandidateRejectDTO., must be smaller than or equal to 500.');
        }
        if (!is_null($reason) && (mb_strlen($reason) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling PersonMergeCandidateRejectDTO., must be bigger than or equal to 0.');
        }
