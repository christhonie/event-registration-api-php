...
/**
 * OrganisationsOverrideRequestDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class OrganisationsOverrideRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganisationsOverrideRequestDTO';
    ...
    */
     ...
     * Sets organisations
     *
     * @param mixed $organisations organisations
     *
     * @return self
     */
    public function setOrganisations($organisations)
    {
        if (is_null($organisations)) {
            array_push($this->openAPINullablesSetToNull, 'organisations');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('organisations', $nullablesSetToNull);
            if ($index !== FALSE) {
