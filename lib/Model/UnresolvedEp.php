...
/**
 * UnresolvedEp Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class UnresolvedEp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnresolvedEp';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('raw_name', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param mixed|null $external_reference_id external_reference_id
     *
     * @return self
     */
    ...
    {
        return $this->container['raw_name'];
    }

    /**
     * Sets raw_name
     *
     * @param mixed|null $raw_name raw_name
     *
     * @return self
     */
    ...
    {
        if (is_null($raw_name)) {
            array_push($this->openAPINullablesSetToNull, 'raw_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('raw_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['raw_name'] = $raw_name;
