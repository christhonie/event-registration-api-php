...
/**
 * RaceNumberBarcodeDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class RaceNumberBarcodeDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RaceNumberBarcodeDTO';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if (!is_null($code) && (mb_strlen($code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $code when calling RaceNumberBarcodeDTO., must be smaller than or equal to 20.');
        }
        if (!is_null($code) && (mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling RaceNumberBarcodeDTO., must be bigger than or equal to 0.');
        }
     ...
     * Sets printed
     *
     * @param mixed|null $printed printed
     *
     * @return self
     */
     ...
     * Sets issued
     *
     * @param mixed|null $issued issued
     *
     * @return self
     */
    ...
    {
        if (is_null($issued)) {
            array_push($this->openAPINullablesSetToNull, 'issued');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('issued', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
