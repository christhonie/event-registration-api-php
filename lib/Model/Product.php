    ...
    */
    ...
    public function setExternalId($external_id)
    {
        ...
        if (!is_null($external_id) && (mb_strlen($external_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling Product., must be smaller than or equal to 50.');
        }
        if (!is_null($external_id) && (mb_strlen($external_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling Product., must be bigger than or equal to 0.');
        }
     ...
     * Sets sales_price
     *
     * @param mixed|null $sales_price sales_price
     *
     * @return self
     */
    public function setSalesPrice($sales_price)
    {
        if (is_null($sales_price)) {
            array_push($this->openAPINullablesSetToNull, 'sales_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sales_price', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets sale_from
     *
     * @param mixed|null $sale_from sale_from
     *
     * @return self
     */
    public function setSaleFrom($sale_from)
    {
        if (is_null($sale_from)) {
            array_push($this->openAPINullablesSetToNull, 'sale_from');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sale_from', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets sale_to
     *
     * @param mixed|null $sale_to sale_to
     *
     * @return self
     */
    ...
    {
        if (is_null($sale_to)) {
            array_push($this->openAPINullablesSetToNull, 'sale_to');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sale_to', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
