...
class ResultSetDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets approved_by
     *
     * @param mixed|null $approved_by approved_by
     *
     * @return self
     */
    public function setApprovedBy($approved_by)
    {
        ...
        if (!is_null($approved_by) && (mb_strlen($approved_by) > 50)) {
        ...
        if (!is_null($approved_by) && (mb_strlen($approved_by) < 0)) {
     ...
     * Sets approved_on
     *
     * @param mixed|null $approved_on approved_on
     *
     * @return self
     */
    public function setApprovedOn($approved_on)
    {
        if (is_null($approved_on)) {
            array_push($this->openAPINullablesSetToNull, 'approved_on');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('approved_on', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets last_update
     *
     * @param mixed|null $last_update last_update
     *
     * @return self
     */
