...
class CategoryDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['owner_organisation'] === null) {
            $invalidProperties[] = "'owner_organisation' can't be null";
        }
     ...
     * Sets min_age
     *
     * @param mixed|null $min_age Minimum allowed age for this category. Leave blank if not applicable.
     *
     * @return self
     */
     ...
     * Sets max_age
     *
     * @param mixed|null $max_age Maximum allowed age for this category. Leave blank if not applicable.
     *
     * @return self
     */
     ...
     * Sets gender
     *
     * @param mixed|null $gender Gender restriction for this category. Leave blank if not applicable.
     *
     * @return self
     */
     ...
     *
     * @param \Idealogic\RegistrationAPI\Model\OrganisationDTO $owner_organisation The organisation controlling this category. For national events this has to be the national organisation.
     *
     * @return self
     */
     ...
     * Sets disciplines
     *
     * @param mixed|null $disciplines The disciplines where this category is active.
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $feeder_categories Categories that feed into this category.
     *
     * @return self
     */
