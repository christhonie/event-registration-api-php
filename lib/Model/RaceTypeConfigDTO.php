...
/**
 * RaceTypeConfigDTO Class Doc Comment
 *
 * @category Class
 * @description Defines the race type variation, which could discriminate between World, National or Regional events,, or based on participant counts.
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RaceTypeConfigDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RaceTypeConfigDTO';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RaceTypeConfigDTO., must be smaller than or equal to 100.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RaceTypeConfigDTO., must be bigger than or equal to 0.');
        }
     ...
     * Sets min_entries
     *
     * @param mixed|null $min_entries Minimum number of entries for this configuration.
     *
     * @return self
     */
     ...
     * Sets max_entries
     *
     * @param mixed|null $max_entries Maximum number of entries for this for this configuration.
     *
     * @return self
     */
     ...
     * Sets race_type
     *
     * @param mixed $race_type Defines the standard race types. This will determine how the event is configured.
     *
     * @return self
     */
