...
/**
 * SourceSystemDTO Class Doc Comment
 *
 * @category Class
 * @package  Idealogic\RegistrationAPI
 * @author   OpenAPI Generator team
 ...
 */
class SourceSystemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SourceSystemDTO';
    ...
    */
     ...
     * Sets is_self
     *
     * @param mixed|null $is_self is_self
     *
     * @return self
     */
    ...
    {
        if (is_null($is_self)) {
            array_push($this->openAPINullablesSetToNull, 'is_self');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_self', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
