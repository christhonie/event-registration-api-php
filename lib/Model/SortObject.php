...
class SortObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets sorted
     *
     * @param mixed|null $sorted sorted
     *
     * @return self
     */
     ...
     * Sets unsorted
     *
     * @param mixed|null $unsorted unsorted
     *
     * @return self
     */
    ...
    {
        if (is_null($unsorted)) {
            array_push($this->openAPINullablesSetToNull, 'unsorted');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('unsorted', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
