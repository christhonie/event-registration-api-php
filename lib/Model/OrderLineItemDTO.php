...
class OrderLineItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param mixed|null $event_participant EventParticipant linked to this item, if applicable
     *
     * @return self
     */
    public function setEventParticipant($event_participant)
    {
        if (is_null($event_participant)) {
            array_push($this->openAPINullablesSetToNull, 'event_participant');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('event_participant', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
