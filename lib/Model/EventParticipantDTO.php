...
class EventParticipantDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $compliance_status compliance_status
     *
     * @return self
     */
    public function setComplianceStatus($compliance_status)
    {
        ...
        $allowedValues = $this->getComplianceStatusAllowableValues();
        if (!in_array($compliance_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'compliance_status', must be one of '%s'",
                    $compliance_status,
     ...
     *
     * @param bool|null $requires_admin_review requires_admin_review
     *
     * @return self
     */
    public function setRequiresAdminReview($requires_admin_review)
    {
        if (is_null($requires_admin_review)) {
            throw new \InvalidArgumentException('non-nullable requires_admin_review cannot be null');
        }
     ...
     *
     * @param string|null $admin_review_reason admin_review_reason
     *
     * @return self
     */
    public function setAdminReviewReason($admin_review_reason)
    {
        if (is_null($admin_review_reason)) {
            throw new \InvalidArgumentException('non-nullable admin_review_reason cannot be null');
        }
        $allowedValues = $this->getAdminReviewReasonAllowableValues();
        if (!in_array($admin_review_reason, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'admin_review_reason', must be one of '%s'",
                    $admin_review_reason,
     ...
     * Sets team
     *
     * @param mixed|null $team In case this is a team members the participant is linked to the team participant entry.
     *
     * @return self
     */
