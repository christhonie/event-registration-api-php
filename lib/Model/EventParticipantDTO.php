...
class EventParticipantDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['order_number']) && (mb_strlen($this->container['order_number']) < 0)) {
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if ((mb_strlen($order_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling EventParticipantDTO., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($order_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling EventParticipantDTO., must be bigger than or equal to 0.');
        }
