...
**preferred_timing_identifier** | **mixed** | Identifier the timing-system export / result-import round-trip uses for this event. Default PERSON_ID for new events. Read by the E08 upload screen to seed the participantIdMode dropdown. Optional on the wire — entity initializer + DB default ensure a non-null value at rest. | [optional]
**preferred_timing_identifier_locked_at** | **mixed** | First-export timestamp; UI gates preferredTimingIdentifier as read-only-with-override after this is set. | [optional]
**source_registration_system** | [**\Idealogic\RegistrationAPI\Model\RegistrationSystemDTO**](RegistrationSystemDTO.md) | External registration system this event&#39;s participants were sourced from (US #769). Defaults the result-import source-system selector; scopes EXTERNAL_PERSON_UID resolution. | [optional]
